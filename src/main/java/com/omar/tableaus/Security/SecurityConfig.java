package com.omar.tableaus.Security;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	 ...
	 * auth.inMemoryAuthentication().withUser("omar").password(passwordEncoder.
	 * encode("123")).roles("AGENT", "USER");
	 * auth.inMemoryAuthentication().withUser("ala").password(passwordEncoder.encode
	 * ("123")).roles("USER");
	 */
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.authorizeRequests().antMatchers("/saveProduit").hasRole("ADMIN");
